...
STATIC EFI_STATUS BlpSetupRomVariable()
{
    __try {
        ...
        UINT8 romBuffer[6]                                                  = {0};
        UINT16 dataSize                                                      = sizeof(romBuffer);
...
STATIC EFI_STATUS BlpCheckBoardId(CHAR8 CONST* boardId, EFI_DEVICE_PATH_PROTOCOL* bootFilePath)
{
    ...
    __try
    {
        ...
        UINT16 count                                                         = CmGetListTagElementsCount(supportedIds);
...
STATIC EFI_STATUS BlpRunAppleBoot(CHAR8 CONST* bootFileName)
{
    ...
    __try {
        ...
        for(UINT16 i = 0; i < totalHandles; i ++) {
...
EFI_STATUS EFIAPI EfiMain(EFI_HANDLE imageHandle, EFI_SYSTEM_TABLE* systemTable)
{
    ...
    __try {
        ...
        // allocate buffer
        //
        UINT16 loaderOptionsSize                                             = (loadedBootImage->LoadOptionsSize / sizeof(CHAR16) + 1) * sizeof(CHAR8);
